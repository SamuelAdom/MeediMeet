...
const Card = ({ title, description }) => {
  return (
    <article className="w-full h-50 md:h-fit md:w-72 bg-gray-700 shadow p-4 space-y-2 rounded-md lg:hover:-translate-y-2 duration-300">
      ...
      <p className="text-sm w-full text-gray-400">{description}</p>
    </article>
  );
};
